...
object Constants {
    ...
    const val SESSION_API_TOKEN = "vijaymadethisapikey"
    const val LOCATION_UPDATE_INTERVAL = 3000L // 3 seconds
    const val DISTANCE_THRESHOLD_METERS = 10.0
    ...
    const val STOP_DISTANCE_RADIUS_THRESHOLD_METERS = 10000
